...
#### Класс CardData
[ ] Дописать класс в конце практической, основываясь на оставшихся методах в классе

Класс для работы с данными принимает событие EventEmitter
...
#### Класс BasketData
Класс данных в корзине. Конструктор принимает событие EventEmitter
...
_content: HTMLElement; - сеттер для сохранения объекта в разметку модального окна
...
Наследуется от класса Card. В конструкторе добавлен необязательный параметр который даёт возможность добавлять поля в объект, который мы отрисовываем
